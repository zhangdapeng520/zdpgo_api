...
import (
	...
	testdata "github.com/zhangdapeng520/zdpgo_gin/libs/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/zhangdapeng520/zdpgo_gin/libs/gin.handlerNameTest$", c.HandlerName())
}
