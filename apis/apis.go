...
var once sync.Once
var internalEngine *zdpgo_api.Engine

func engine() *zdpgo_api.Engine {
	once.Do(func() {
		internalEngine = zdpgo_api.Default()
	})
...
func NoRoute(handlers ...zdpgo_api.HandlerFunc) {
	engine().NoRoute(handlers...)
}

// NoMethod is a wrapper for Engine.NoMethod.
func NoMethod(handlers ...zdpgo_api.HandlerFunc) {
...
func Group(relativePath string, handlers ...zdpgo_api.HandlerFunc) *zdpgo_api.RouterGroup {
	return engine().Group(relativePath, handlers...)
}

// Handle is a wrapper for Engine.Handle.
func Handle(httpMethod, relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().Handle(httpMethod, relativePath, handlers...)
}

// POST is a shortcut for router.Handle("POST", path, handle)
func POST(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().POST(relativePath, handlers...)
}

// GET is a shortcut for router.Handle("GET", path, handle)
func GET(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().GET(relativePath, handlers...)
}

// DELETE is a shortcut for router.Handle("DELETE", path, handle)
func DELETE(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().DELETE(relativePath, handlers...)
}

// PATCH is a shortcut for router.Handle("PATCH", path, handle)
func PATCH(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().PATCH(relativePath, handlers...)
}

// PUT is a shortcut for router.Handle("PUT", path, handle)
func PUT(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().PUT(relativePath, handlers...)
}

// OPTIONS is a shortcut for router.Handle("OPTIONS", path, handle)
func OPTIONS(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().OPTIONS(relativePath, handlers...)
}

// HEAD is a shortcut for router.Handle("HEAD", path, handle)
func HEAD(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().HEAD(relativePath, handlers...)
}

// Any is a wrapper for Engine.Any.
func Any(relativePath string, handlers ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().Any(relativePath, handlers...)
}

// StaticFile is a wrapper for Engine.StaticFile.
func StaticFile(relativePath, filepath string) zdpgo_api.IRoutes {
...
func Static(relativePath, root string) zdpgo_api.IRoutes {
	return engine().Static(relativePath, root)
}

// StaticFS is a wrapper for Engine.StaticFS.
func StaticFS(relativePath string, fs http.FileSystem) zdpgo_api.IRoutes {
...
func Use(middlewares ...zdpgo_api.HandlerFunc) zdpgo_api.IRoutes {
	return engine().Use(middlewares...)
}

// Routes returns a slice of registered routes.
func Routes() zdpgo_api.RoutesInfo {
