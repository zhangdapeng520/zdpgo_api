...
import (
	...
	"github.com/zhangdapeng520/zdpgo_api/gin/render"
	"github.com/zhangdapeng520/zdpgo_api/sse"
)
	...
	if c.formCache == nil {
		...
		if err := req.ParseMultipartForm(c.engine.MaxMultipartMemory); err != nil {
			if err != http.ErrNotMultipart {
				Log.Debug("error on parse multipart form array", "error", err)
			}
		}
...
func (c *Context) ClientIP() string {
	...
	if c.engine.AppEngine {
		log.Println(`The AppEngine flag is going to be deprecated. Please check issues #2723 and #2739 and use 'TrustedPlatform: api.PlatformGoogleAppEngine' instead.`)
