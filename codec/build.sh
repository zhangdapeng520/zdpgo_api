...
EOF
    ...
    sed -e 's+// __DO_NOT_REMOVE__NEEDED_FOR_REPLACING__IMPORT_PATH__FOR_CODEC_BENCH__+import . "github.com/zhangdapeng520/zdpgo_api/codec"+' \
...
_prebuild() {
    ...
    local zpkg="github.com/zhangdapeng520/zdpgo_api/codec"
    local returncode=1
